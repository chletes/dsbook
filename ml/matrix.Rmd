...
```{r matrix-image, fig.width = 8, fig.height = 4}
rafalib::mypar(1,2)
image(1:28, 1:28, grid)
image(1:28, 1:28, grid[, 28:1])
```
...
```{r pixel-variance, fig.width = 3, fig.height = 3, out.width="50%"}
rafalib::mypar()
image(1:28, 1:28, matrix(sds, 28, 28)[, 28:1])
```
...
```{r binarized-image, out.width="100%", fig.width = 6, fig.height = 3.25}
rafalib::mypar(1,2)
rows <- 1:28
columns <- 1:28
