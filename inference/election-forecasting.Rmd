...
```{r simulated-data-without-bias, message=FALSE, warning=FALSE}
...
```{r simulated-pollster-data, fig.height=3.78, fig.width=3, out.width="35%"}
...
```{r election-forecast-posterior-no-bias}
...
```{r comparison-forecast-with-and-without-bias}
