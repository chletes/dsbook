...
```{r, echo=FALSE}
knitr::include_graphics(file.path(wd, img_path,"git/git-clone.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(file.path(wd, img_path, "git/git-status.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(file.path(wd, img_path,"git/git-add.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(file.path(wd, img_path,"/git/git-commit.png"))
```
